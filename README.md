...
ROS 2 pacage template, to get started, use template by clicking on the Green button labeled [`Use this template`](https://github.com/Levente011/temperature_monitoring/generate) / [`Create new repository`](https://github.com/Levente011/temperature_monitoring/generate). 
...
- `temperature_monitoring` >> `cool_ros2_package` (the folder was already renamed after `Use this template`)
- `Levente011` >> `mycoolusername`
